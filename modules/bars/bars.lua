DFRL:NewDefaults("Bars", {
    enabled = {true},
    movable = {true},
    barsDarkMode = {0, "slider", {0, 1}, nil, "外观", 1, "调整暗色模式强度", nil, nil},
    ...
    mainBarSpacing = {6, "slider", {0, 20}, nil, "主动作条", 5, "调整主动作条按钮之间的间距", nil, nil},
    mainBarAlpha = {1, "slider", {0.1, 1}, nil, "主动作条", 6, "调整主动作条的透明度", nil, nil},
    mainBarGrid = {1, "slider", {1, 6}, nil, "主动作条", 7, "更改主动作条的网格布局", nil, nil},
    highlightColor = {{1, 0.82, 0}, "colour", nil, nil, "主动作条", 8, "更改动作按钮高亮的颜色", nil, nil},
    multiBarOneShow = {false, "checkbox", nil, nil, "多动作条 1", 9, "显示或隐藏左下动作条", nil, nil},
    multiBarOneScale = {1, "slider", {0.2, 2}, nil, "多动作条 1", 10, "调整左下动作条的缩放", nil, nil},
    multiBarOneSpacing = {6, "slider", {0.1, 20}, nil, "多动作条 1", 11, "调整左下动作条按钮之间的间距", nil, nil},
    multiBarOneAlpha = {1, "slider", {0.1, 1}, nil, "多动作条 1", 12, "调整左下动作条的透明度", nil, nil},
    multiBarOneGrid = {1, "slider", {1, 6}, nil, "多动作条 1", 13, "更改左下动作条的网格布局", nil, nil},
    multiBarTwoShow = {false, "checkbox", nil, nil, "多动作条 2", 14, "显示或隐藏右下动作条", nil, nil},
    multiBarTwoScale = {1, "slider", {0.2, 2}, nil, "多动作条 2", 15, "调整右下动作条的缩放", nil, nil},
    multiBarTwoSpacing = {6, "slider", {0.1, 20}, nil, "多动作条 2", 16, "调整右下动作条按钮之间的间距", nil, nil},
    multiBarTwoAlpha = {1, "slider", {0.1, 1}, nil, "多动作条 2", 17, "调整右下动作条的透明度", nil, nil},
    multiBarTwoGrid = {1, "slider", {1, 6}, nil, "多动作条 2", 18, "更改右下动作条的网格布局", nil, nil},
    multiBarThreeShow = {false, "checkbox", nil, nil, "多动作条 3", 19, "显示或隐藏左侧动作条", nil, nil},
    multiBarThreeScale = {0.8, "slider", {0.2, 2}, nil, "多动作条 3", 20, "调整左侧动作条的缩放", nil, nil},
    multiBarThreeSpacing = {6, "slider", {0.1, 20}, nil, "多动作条 3", 21, "调整左侧动作条按钮之间的间距", nil, nil},
    multiBarThreeAlpha = {1, "slider", {0.1, 1}, nil, "多动作条 3", 22, "调整左侧动作条的透明度", nil, nil},
    multiBarThreeGrid = {6, "slider", {1, 6}, nil, "多动作条 3", 23, "更改左侧动作条的网格布局", nil, nil},
    multiBarFourShow = {true, "checkbox", nil, nil, "多动作条 4", 24, "显示或隐藏右侧动作条", nil, nil},
    multiBarFourScale = {0.8, "slider", {0.2, 2}, nil, "多动作条 4", 25, "调整右侧动作条的缩放", nil, nil},
    multiBarFourSpacing = {6, "slider", {0.1, 20}, nil, "多动作条 4", 26, "调整右侧动作条按钮之间的间距", nil, nil},
    multiBarFourAlpha = {1, "slider", {0.1, 1}, nil, "多动作条 4", 27, "调整右侧动作条的透明度", nil, nil},
    multiBarFourGrid = {6, "slider", {1, 6}, nil, "多动作条 4", 28, "更改右侧动作条的网格布局", nil, nil},
    showGryphoon = {true, "checkbox", nil, nil, "主动作条装饰", 29, "显示或隐藏狮鹫/双足飞龙装饰", nil, nil},
    altGryphoon = {false, "checkbox", nil, nil, "主动作条装饰", 30, "使用替代的狮鹫/双足飞龙纹理", nil, nil},
    flipGryphoon = {false, "checkbox", nil, nil, "主动作条装饰", 31, "翻转狮鹫/双足飞龙纹理", nil, nil},
    ...
    pagingSwap = {true, "checkbox", nil, nil, "主动作条翻页", 37, "交换翻页按钮的锚点位置", nil, nil},
    pagingX = {15, "slider", {0, 150}, nil, "主动作条翻页", 38, "调整翻页按钮的水平位置", nil, nil},
    pagingScale = {0.9, "slider", {0.7, 1.8}, nil, "主动作条翻页", 39, "调整翻页按钮的缩放", nil, nil},
    hotkeyFont = {"FRIZQT__.TTF", "dropdown", {"FRIZQT__.TTF", "Expressway", "Homespun", "Hooge", "Myriad-Pro", "Prototype", "PT-Sans-Narrow-Bold", "PT-Sans-Narrow-Regular", "RobotoMono", "BigNoodleTitling", "Continuum", "DieDieDie"}, nil, "文本设置", 40, "更改快捷键和宏使用的字体", nil, nil},
    hotkeyColour = {{1, 0.82, 0}, "colour", nil, nil, "文本设置", 41, "更改动作按钮上按键绑定文本的颜色", nil, nil},
    hotkeyShow = {true, "checkbox", nil, nil, "文本设置", 42, "显示或隐藏动作按钮上的按键绑定文本", nil, nil},
    hotkeyScale = {1.4, "slider", {0.5, 2}, nil, "文本设置", 43, "调整动作按钮上按键绑定文本的大小", nil, nil},
    hotkeyX = {0, "slider", {-50, 50}, nil, "文本设置", 44, "调整按键绑定文本的水平位置", nil, nil},
    hotkeyY = {-2, "slider", {-50, 50}, nil, "文本设置", 45, "调整按键绑定文本的垂直位置", nil, nil},
    macroColour = {{1, 1, 1}, "colour", nil, nil, "文本设置", 46, "更改动作按钮上宏文本的颜色", nil, nil},
    macroShow = {true, "checkbox", nil, nil, "文本设置", 47, "显示或隐藏动作按钮上的宏文本", nil, nil},
    macroScale = {1.3, "slider", {0.5, 2}, nil, "文本设置", 48, "调整动作按钮上宏文本的大小", nil, nil},
    macroX = {0, "slider", {-50, 50}, nil, "文本设置", 49, "调整宏文本的水平位置", nil, nil},
    macroY = {2, "slider", {-50, 50}, nil, "文本设置", 50, "调整宏文本的垂直位置", nil, nil},
    petbarScale = {0.8, "slider", {0.2, 2}, nil, "宠物条", 51, "调整宠物动作条的缩放", nil, nil},
    petbarSpacing = {6, "slider", {0.1, 20}, nil, "宠物条", 52, "调整宠物动作条按钮之间的间距", nil, nil},
    petbarAlpha = {1, "slider", {0.1, 1}, nil, "宠物条", 53, "调整宠物动作条的透明度", nil, nil},
    shapeshiftScale = {0.8, "slider", {0.2, 2}, nil, "姿态条", 54, "调整姿态条的缩放", nil, nil},
    shapeshiftSpacing = {6, "slider", {0.1, 20}, nil, "姿态条", 55, "调整姿态条按钮之间的间距", nil, nil},
    shapeshiftAlpha = {1, "slider", {0.1, 1}, nil, "姿态条", 56, "调整姿态条的透明度", nil, nil},
})
