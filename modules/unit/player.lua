DFRL:NewDefaults("Player", {
    ...
    textShow = {true, "checkbox", nil, nil, "文本", 7, "显示生命值和法力值文本", nil, nil},
    textMaxShow = {true, "checkbox", nil, "textShow", "文本", 8, "显示最大生命值和法力值文本", nil, nil},
    noPercent = {true, "checkbox", nil, "textShow", "文本", 9, "仅显示当前数值，不显示百分比", nil, nil},
    textColoringHealth = {false, "checkbox", nil, "textShow", "文本", 10, "根据生命值百分比将文本从白色渐变为红色", nil, nil},
    textColoringResource = {false, "checkbox", nil, "textShow", "文本", 11, "根据资源（法力/怒气/能量）百分比将文本从白色渐变为红色", nil, nil},
    frameFont = {"FRIZQT__.TTF", "dropdown", {
        ...
        "Continuum",
        "DieDieDie"
    }, nil, "文本", 12, "更改玩家框体使用的字体", nil, nil},
    healthSize = {15, "slider", {8, 20}, "textShow", "文本", 13, "生命值文本字体大小", nil, nil},
    manaSize = {9, "slider", {8, 20}, "textShow", "文本", 14, "法力值文本字体大小", nil, nil},
    nameSize = {9, "slider", {6, 16}, nil, "文本", 15, "名称文本字体大小", nil, nil},
    levelSize = {9, "slider", {6, 16}, nil, "文本", 16, "等级文本字体大小", nil, nil},
    classColor = {false, "checkbox", nil, nil, "生命条", 17, "根据职业着色生命条", nil, nil},
    enablePulse = {true, "checkbox", nil, nil, "生命条", 18, "启用条带动画脉冲效果", nil, nil},
    pulseColor = {{1, 1, 1}, "colour", nil, "enablePulse", "生命条", 19, "脉冲动画颜色", nil, nil},
    enableCutout = {true, "checkbox", nil, nil, "生命条", 20, "启用条带切割动画效果", nil, nil},
    cutoutColor = {{1, 0, 0}, "colour", nil, "enableCutout", "生命条", 21, "伤害切割效果颜色", nil, nil},
    energyTick = {true, "checkbox", nil, nil, "生命条", 22, "显示能量和法力刻度指示器", nil, nil},
    ...
    restingColor = {{0, 1, 1}, "colour", nil, "restingGlow", "休息效果", 29, "更改休息发光动画颜色", nil, nil},
})
