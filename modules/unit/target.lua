DFRL:NewDefaults("Target", {
    enabled = {true},
    targetDarkMode = {0, "slider", {0, 1}, nil, "外观", 1, "调整暗色模式强度", nil, nil},
    targetColor = {{1, 1, 1}, "colour", nil, nil, "外观", 2, "更改目标颜色", nil, nil},
    frameScale = {1, "slider", {0.7, 1.3}, nil, "外观", 3, "调整框体大小", nil, nil},
    textShow = {true, "checkbox", nil, nil, "文本", 4, "显示生命值和法力值文本", nil, nil},
    textMaxShow = {true, "checkbox", nil, "textShow", "文本", 5, "显示最大生命值和法力值文本", nil, nil},
    noPercent = {true, "checkbox", nil, "textShow", "文本", 6, "仅显示当前数值，不显示百分比", nil, nil},
    textColoringHealth = {false, "checkbox", nil, "textShow", "文本", 7, "根据生命值百分比着色文本", nil, nil},
    textColoringResource = {false, "checkbox", nil, "textShow", "文本", 8, "根据资源（法力/怒气/能量）百分比着色文本", nil, nil},
    frameFont = {"FRIZQT__.TTF", "dropdown", {
        ...
        "Continuum",
        "DieDieDie"
    }, nil, "文本", 9, "更改目标框体使用的字体", nil, nil},
    healthSize = {15, "slider", {8, 20}, "textShow", "文本", 10, "生命值文本字体大小", nil, nil},
    manaSize = {9, "slider", {8, 20}, "textShow", "文本", 11, "法力值文本字体大小", nil, nil},
    nameSize = {9, "slider", {6, 16}, nil, "文本", 12, "目标名称文本字体大小", nil, nil},
    levelSize = {9, "slider", {6, 16}, nil, "文本", 13, "目标等级文本字体大小", nil, nil},
    colorReaction = {true, "checkbox", nil, nil, "生命条", 14, "根据目标反应着色生命条", nil, nil},
    colorClass = {false, "checkbox", nil, nil, "生命条", 15, "根据目标职业着色生命条", nil, nil},
    enablePulse = {true, "checkbox", nil, nil, "生命条", 16, "启用条带动画脉冲效果", nil, nil},
    pulseColor = {{1, 1, 1}, "colour", nil, "enablePulse", "生命条", 17, "脉冲动画颜色", nil, nil},
    enableCutout = {true, "checkbox", nil, nil, "生命条", 18, "启用条带切割动画效果", nil, nil},
    cutoutColor = {{1, 0, 0}, "colour", nil, "enableCutout", "生命条", 19, "伤害切割效果颜色", nil, nil},
})
